...
const skills = {
  Frontend: [
    { name: "HTML 5", icon: <AiFillHtml5 size="25px" />, color: "text-orange-500" },
    { name: "CSS", icon: <BiLogoCss3 size="25px" />, color: "text-blue-500" },
    { name: "JavaScript", icon: <BiLogoJavascript size="25px" />, color: "text-yellow-400" },
    { name: "React", icon: <FaReact size="25px" />, color: "text-cyan-400" },
    { name: "Bootstrap", icon: <FaBootstrap size="25px" />, color: "text-purple-600" },
    { name: "Responsive", icon: <FaMobileAlt size="25px" />, color: "text-gray-400" },
  ],
  Backend: [
    { name: "Node.js", icon: <BiLogoNodejs size="25px" />, color: "text-green-500" },
    { name: "Java", icon: <BiLogoJava size="25px" />, color: "text-red-500" },
    { name: "Dotnet", icon: <SiBattledotnet size="25px" />, color: "text-purple-500" },
  ],
  Database: [
    { name: "MongoDB", icon: <BiLogoMongodb size="25px" />, color: "text-green-500" },
    { name: "PostgreSQL", icon: <BiLogoPostgresql size="25px" />, color: "text-blue-400" },
  ],
  Tools: [
      ...
      <div className="grid md:grid-cols-2 gap-12 items-start">
        ...
        >
          ...
          <p className="text-dark-muted leading-relaxed mb-6">
            I am a student and aspiring software developer from Coimbatore, with a
            strong interest in software development, full-stack development, and
            UI/UX design. I am focused on building a solid foundation in
            technology and design while exploring innovative solutions to complex
            challenges.
          </p>
        ...
        <div className="space-y-8">
          ...
          {Object.entries(skills).map(([category, categorySkills], categoryIndex) => (
            <motion.div
              ...
              className="mb-6"
            >
              <h4 className="text-lg font-semibold text-primary-light mb-4">{category}</h4>
              <div className="flex flex-wrap gap-3">
                {categorySkills.map((skill, index) => (
                  ...
                  >
                    <span className={`${skill.color} text-2xl group-hover:animate-bounce`}>{skill.icon}</span>
                    <span className="text-gray-300 font-medium text-sm group-hover:text-white transition-colors">{skill.name}</span>
                  </motion.div>
                ))}
              </div>
            </motion.div>
